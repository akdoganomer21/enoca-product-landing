...
const FEATURES = [
  {
    ...
    description:
      "Track your system performance in real-time with visual insights.",
  },
  {
    title: "Energy Optimization",
    description:
      "Save up to 30% by optimizing energy consumption intelligently.",
  },
  {
  ...
  return (
    <section className={styles.features} id="features">
      ...
      <p className={styles.subtitle}>
        Explore the core benefits of our solution that make your energy systems
        smarter.
      </p>
